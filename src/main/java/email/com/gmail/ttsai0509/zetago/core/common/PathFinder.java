...
public class PathFinder {
    ...
    public PathFinder(int nodesW, int nodesH, int nodesD) {
        this.nodesW = nodesW;
        this.nodesH = nodesH;
        this.nodesD = nodesD;
        this.nodes = new Node[nodesW * nodesH * nodesD];
        this.comparator = new Heuristic();
        this.queue = new PriorityQueue<>(comparator);

        for (int i = 0; i < nodes.length; i++)
            this.nodes[i] = new Node(i % nodesW, i / nodesW % nodesH, i / nodesW / nodesH % nodesD);
    }
